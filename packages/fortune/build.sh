...
termux_step_make_install () {
	...
	$CC $CFLAGS fortune.c -o $TERMUX_DESTDIR/usr/bin/fortune
	mkdir -p $TERMUX_DESTDIR/usr/share/man/man6
	cp debian/fortune.6 $TERMUX_DESTDIR/usr/share/man/man6/
	...
	mkdir -p $TERMUX_DESTDIR/usr/share/games/fortunes
	cp * $TERMUX_DESTDIR/usr/share/games/fortunes
}
