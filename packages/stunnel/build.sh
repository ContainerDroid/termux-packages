...
TERMUX_PKG_EXTRA_CONFIGURE_ARGS="--disable-shared --with-ssl=$TERMUX_DESTDIR/usr --disable-fips"
TERMUX_PKG_RM_AFTER_INSTALL="usr/bin/stunnel3 usr/share/man/man8/stunnel.*.8"
