...
TERMUX_PKG_SHA256=8c924a71a35becb169b9e0a6b4628997503f30a74563c0e2d0bdf55dbb82d675
...
TERMUX_PKG_RM_AFTER_INSTALL="usr/bin/weechat-curses usr/share/icons"
TERMUX_PKG_EXTRA_CONFIGURE_ARGS="
-DCA_FILE=$TERMUX_DESTDIR/etc/tls/cert.pem
-DENABLE_LUA=ON
-DENABLE_MAN=ON
-DENABLE_PERL=ON
-DENABLE_PYTHON3=ON
