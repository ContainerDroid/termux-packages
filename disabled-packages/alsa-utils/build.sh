...
TERMUX_PKG_EXTRA_CONFIGURE_ARGS="--with-udev-rules-dir=$TERMUX_DESTDIR/usr/lib/udev/rules.d --with-asound-state-dir=$TERMUX_DESTDIR/var/lib/alsa --disable-bat --disable-rst2man"
