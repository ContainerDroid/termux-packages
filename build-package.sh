...
termux_step_setup_variables() {
	...
	TERMUX_COMMON_CACHEDIR="$TERMUX_SCRIPTDIR/cache"
	...
	TERMUX_PKG_CACHEDIR=$TERMUX_COMMON_CACHEDIR/$TERMUX_PKG_NAME
	...
	TERMUX_PKG_MAINTAINER="Vladimir Oltean <olteanv@gmail.com>"
